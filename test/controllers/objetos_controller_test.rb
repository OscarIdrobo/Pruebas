...
class ObjetosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create objeto" do
    assert_difference('Objeto.count') do
      post objetos_url, params: { objeto: { Descripcion: @objeto.Descripcion, Nombre_Objeto: @objeto.Nombre_Objeto } }
    end
  ...
  test "should update objeto" do
    patch objeto_url(@objeto), params: { objeto: { Descripcion: @objeto.Descripcion, Nombre_Objeto: @objeto.Nombre_Objeto } }
